...
class Launchpad_Mini_MK3(NovationBase):
    ...
    def _create_stop_solo_mute_modes(self):
        ...
        self._stop_solo_mute_modes.add_mode(u'arm', AddLayerMode(self._mixer, Layer(arm_buttons=bottom_row)), cycle_mode_button_color=u'Mixer.ArmOn')
        self._stop_solo_mute_modes.add_mode(u'track_select', AddLayerMode(self._mixer, Layer(track_select_buttons=bottom_row)), cycle_mode_button_color=u'DefaultButton.On')
