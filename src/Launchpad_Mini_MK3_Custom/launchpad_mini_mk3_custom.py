...
class Launchpad_Mini_MK3_Custom(NovationBase):
    ...
    def __init__(self, *a, **k):
        ...
        (super(Launchpad_Mini_MK3_Custom, self).__init__)(*a, **k)
    ...
    def on_identified(self, midi_bytes):
        ...
        super(Launchpad_Mini_MK3_Custom, self).on_identified(midi_bytes)

    def _create_components(self):
        super(Launchpad_Mini_MK3_Custom, self)._create_components()
        self._create_background()
        self._create_stop_solo_mute_modes()
        self._create_session_modes()
        self._Launchpad_Mini_MK3_Custom__on_layout_switch_value.subject = self._elements.layout_switch

    def _create_session_layer(self):
        return super(Launchpad_Mini_MK3_Custom, self)._create_session_layer() + Layer(scene_launch_buttons='scene_launch_buttons')
    ...
    def _create_stop_solo_mute_modes(self):
        ...
        self._stop_solo_mute_modes.add_mode('track_select', 
    ...
    def _create_session_modes(self):
        ...
        self._Launchpad_Mini_MK3_Custom__on_session_mode_changed.subject = self._session_modes
    ...
    def _create_background(self):
        ...
        self._Launchpad_Mini_MK3_Custom__on_background_control_value.subject = self._background
...
# okay decompiling launchpad_mini_mk3.pyc
