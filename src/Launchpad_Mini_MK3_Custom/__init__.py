...
from .launchpad_mini_mk3_custom import Launchpad_Mini_MK3_Custom
...
def get_capabilities():
    return {CONTROLLER_ID_KEY: controller_id(vendor_id=4661,
                          product_ids=[275],
                          model_name=['Launchpad Mini MK3 Custom']), 
...
def create_instance(c_instance):
    return Launchpad_Mini_MK3_Custom(c_instance=c_instance)
